<?php
    ...
    if ($type == 'rejected') {
        $sql = $conn->query("SELECT * FROM rejectedreservations WHERE ID = $bookingID;") or die($conn->error);
            ...
            $output .='
                ...
                <div class="md:hidden space-y-7">
                    ...
                    <div class="flex items-start space-x-5">
                        <div>
                            <img src="assets/reservations-images/rejected.png" alt="" class="w-10">
                        </div>

                        <div class="">
                            <div class="mb-4">
                                <h1 class="text-slate-400">Status</h1>
                                <h1 class="font-bold text-lg text-red-500">Rejected</h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between items-start border-dotted border-b-2 mb-14">
                        ...
                        <div class="flex items-start space-x-5 mb-3">
                            ...
                            <div class="">
                                <div class="mb-4">
                                    <h1 class="text-slate-400">Status</h1>
                                    <h1 class="font-bold text-md md:text-xl text-red-500">Rejected</h1>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    elseif ($type == 'expired') {
        $sql = $conn->query("SELECT * FROM expiredreservations WHERE ID = $bookingID;") or die($conn->error);
        while ($row = mysqli_fetch_assoc($sql)) {
            $reservationType = $row['reservationtype'];
            $timeStamp = $row['booking_timestamp'];
            $firstName = $row['firstname'];
            ...
            $output .='
                ...
                <div class="md:hidden space-y-7">
                    ...
                    <div class="flex items-start space-x-5">
                        <div>
                            <img src="assets/reservations-images/invalid.png" alt="" class="w-10">
                        </div>

                        <div class="">
                            <div class="mb-4">
                                <h1 class="text-slate-400">Status</h1>
                                <h1 class="font-bold text-lg text-red-500">Expired</h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between items-start border-dotted border-b-2 mb-14">
                        ...
                        <div class="flex items-start space-x-5 mb-3">
                            ...
                            <div class="">
                                <div class="mb-4">
                                    <h1 class="text-slate-400">Status</h1>
                                    <h1 class="font-bold text-md md:text-xl text-red-500">Expired</h1>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    elseif ($type == 'completed') {
        $sql = $conn->query("SELECT * FROM completedreservations WHERE ID = $bookingID;") or die($conn->error);
        while ($row = mysqli_fetch_assoc($sql)) {
            $reservationType = $row['reservationtype'];
                ...
                <div class="md:hidden space-y-7">
                    ...
                    <div class="flex items-start space-x-5">
                        ...
                        <div class="">
                            <div class="mb-4">
                                <h1 class="text-slate-400">Status</h1>
                                <h1 class="font-bold text-lg text-lime-400">Completed</h1>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-between items-start border-dotted border-b-2 mb-14">
                        ...
                        <div class="flex items-start space-x-5 mb-3">
                            ...
                            <div class="">
                                <div class="mb-4">
                                    <h1 class="text-slate-400">Status</h1>
                                    <h1 class="font-bold text-md md:text-xl text-lime-400">Completed</h1>
                                </div>
                            </div>
                        </div>
                    </div>
