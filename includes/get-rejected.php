<?php
    ...
    $output = '';
    $result = $conn->query("SELECT * FROM (SELECT * FROM rejectedreservations WHERE remarks = 'Rejected') rejectedreservations WHERE listing_id = $listingID;") or die($conn->error);
