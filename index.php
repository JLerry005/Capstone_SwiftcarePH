                ...
                if (!isset($_SESSION["sessionpatientUserID"])) {
                    echo '
                        ...
                        <div class="md:hidden text-left space-y-2">
                            ...
                            <a href="user-signup.php" class="flex items-center w-fit p-2 px-4 bg-orange-500 rounded-md text-sm">
                            ...
                            <p class="">Already have an Account? <a href="user-login.php" class="hover:underline hover:text-blue-500">Login</a></p>
                        </div>
                    ';
                }
