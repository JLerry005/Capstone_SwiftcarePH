                ...
                <div class="relative bg-gray-900 rounded-lg shadow">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="p-6 space-y-2">
                            ...
                            <!-- Patient Name -->
                            <div class="text-gray-900 mb-4 font-semibold">
                                <p>Patient Name</p>
                            </div>
                            ...
                            <div class="grid xl:grid-cols-2 xl:gap-6">
                                ...
                                <div class="relative z-0 mb-6 w-full group">
                                    ...
                                    <label for="firstName" class="absolute text-sm text-gray-800 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">First name</label>
                                </div>
                                <!-- Patient Last Name -->
                                <div class="relative z-0 mb-6 w-full group">
                            ...
                            <!-- Appointment -->
                            <div class="text-gray-900 pb-4 font-semibold">
                                <p>Appointment:</p>
                            </div>
                            ...
                            <div class="grid xl:grid-cols-2 xl:gap-6">
                                <!-- Date -->
                                <div class="relative z-0 mb-6 w-full group">
                                    <input type="date" name="date" id="date_picker" class="empty block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
