        ...
        <div class="" id="contents-container">
                    ...
                    <div id="pending-button" class="flex justify-between p-6 bg-gray-800 hover:bg-gray-700 transition-all rounded-lg drop-shadow-lg hover:cursor-pointer">
                        ...
                        <div class="flex flex-col justify-between">
                            <div>
                                ...
                                <h1 class="text-4xl font-bold hover:underline cursor-pointer">4</h1>
                            </div>
            ...
            <div id="history-contents" style="display: none;">
                ...
                <div class="px-5 lg:grid grid-cols-12 gap-4" id="completed-cards-container">
                    ...
                    <!-- Cards -->
                    <div class="text-xs md:text-sm md:col-span-12 lg:col-span-4 bg-blue-400 rounded-lg text-gray-700 hover:scale-105 hover:drop-shadow-md hover:cursor-pointer transition duration-100 ease-out"> 
                        <div class="bg-blue-500 p-2 rounded-t-lg flex items-center justify-between">
                            <div>
                                <p class="flex items-center cursor-default py-0.5 px-2 w-fit text-white font-medium tracking-wider">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-5 w-5 mr-2"><path fill="none" d="M0 0H24V24H0z"/><path d="M17 2v2h3c.552 0 1 .448 1 1v16c0 .552-.448 1-1 1H4c-.552 0-1-.448-1-1V5c0-.552.448-1 1-1h3V2h10zM7 6H5v14h14V6h-2v2H7V6zm6 5v2h2v2h-2.001L13 17h-2l-.001-2H9v-2h2v-2h2zm2-7H9v2h6V4z" fill="rgba(0,0,0,1)"/></svg> SCPHRES149206</p>
                                </p>
                            </div>
                        ...
                        <div class="p-2 pt-3 sm:p-4 flex items-center justify-between">
                            <div class="flex items-center space-x-3">
                                ...
                                <a href="#" class="flex items-center bg-white hover:bg-gray-300 cursor-pointer rounded-full py-0.5 px-2 w-fit text-blue-700 font-bold">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="h-4 w-4 mr-1 ="><path fill="none" d="M0 0H24V24H0z"/><path d="M8 3v2H6v4c0 2.21 1.79 4 4 4s4-1.79 4-4V5h-2V3h3c.552 0 1 .448 1 1v5c0 2.973-2.162 5.44-5 5.917V16.5c0 1.933 1.567 3.5 3.5 3.5 1.497 0 2.775-.94 3.275-2.263C16.728 17.27 16 16.22 16 15c0-1.657 1.343-3 3-3s3 1.343 3 3c0 1.371-.92 2.527-2.176 2.885C19.21 20.252 17.059 22 14.5 22 11.462 22 9 19.538 9 16.5v-1.583C6.162 14.441 4 11.973 4 9V4c0-.552.448-1 1-1h3zm11 11c-.552 0-1 .448-1 1s.448 1 1 1 1-.448 1-1-.448-1-1-1z" fill="rgba(26,86,219,1)"/></svg>Non-Covid
                                </a>
                            </div>
                            
                            <p class="flex items-center text-gray-900">
                                <i class="bi bi-clock-history hover:text-blue-500"></i> &nbsp;April 18, 2022
                            </p>
                        </div>

                        <div class="mb-2 px-4 flex items-center space-x-3">
                            <img src="https://avatars.dicebear.com/api/big-smile/'.$firstName.'.svg?b=%231a56bb&r=50" alt="" srcset="" class="w-10">
                            <h1 class="text-lg font-bold text-gray-900 capitalize">Aqua Sweet</h1>
                        </div>
                        <div class="flex items-start justify-between px-4">
